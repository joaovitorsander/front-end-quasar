          ...
          <q-table :rows="campeonatos" :columns="columns" row-key="id" title="Campeonatos Cadastrados" dense flat
            ...
            <template v-slot:body-cell-actions="props">
              <q-td :props="props" align="right">
                <q-btn flat round icon="edit" @click="loadCampeonato(props.row)" />
                <q-btn flat round icon="delete" color="negative" @click="deleteCampeonato(props.row.id)" />
              </q-td>
            </template>
          </q-table>
        </q-card>
...
const columns = [
  { name: 'nome_camp', label: 'Nome do Campeonato', align: 'left', field: 'nome_camp', sortable: true },
  { name: 'time', label: 'Time', align: 'left', field: 'time', sortable: true },
  { name: 'premiacao', label: 'Premiação', align: 'left', field: 'premiacao', sortable: true },
  { name: 'organizacao', label: 'Organização', align: 'left', field: 'organizacao', sortable: true },
  { name: 'edicao', label: 'Edição', align: 'left', field: 'edicao', sortable: true },
  { name: 'formato', label: 'Formato', align: 'left', field: 'formato', sortable: true },
  { name: 'data_inicio_camp', label: 'Data de Início', align: 'left', field: 'data_inicio_camp', sortable: true },
...
function loadCampeonato(camp) {
  ...
  data_inicio_camp.value = camp.data_inicio_camp;
