      ...
      <div class="form-section">
        <q-card class="q-pa-md custom-card">
          <q-form @submit.prevent="submitAgent">
            <q-input filled v-model="agentName" label="Nome do Agente" class="q-mb-md" />
            <q-select filled v-model="sexo" :options="sexoOptions" label="Sexo" option-label="label"
              option-value="value" class="q-mb-md" />
            <q-input filled v-model="habilidade1" label="Habilidade 1" class="q-mb-md" />
            <q-input filled v-model="habilidade2" label="Habilidade 2" class="q-mb-md" />
            <q-input filled v-model="habilidade3" label="Habilidade 3" class="q-mb-md" />
            <q-input filled v-model="ultimate" label="Ultimate" class="q-mb-md" />
          ...
          <q-table v-if="Array.isArray(agentes) && agentes.length > 0" :rows="agentes" :columns="columns" row-key="id"
            ...
            <template v-slot:body-cell-actions="props">
              <q-td :props="props" align="right">
                ...
                <q-btn flat round icon="delete" color="negative" @click="deleteAgent(props.row.id)" />
              </q-td>
            </template>
          </q-table>
...
const columns = [
  { name: 'nome_agente', label: 'Nome', align: 'left', field: 'nome_agente', sortable: true },
  { name: 'sexo', label: 'Sexo', align: 'left', field: 'sexo', sortable: true },
  { name: 'habilidade1', label: 'Habilidade 1', align: 'left', field: 'habilidade1', sortable: true },
  { name: 'habilidade2', label: 'Habilidade 2', align: 'left', field: 'habilidade2', sortable: true },
  { name: 'habilidade3', label: 'Habilidade 3', align: 'left', field: 'habilidade3', sortable: true },
  { name: 'ultimate', label: 'Ultimate', align: 'left', field: 'ultimate', sortable: true },
